...
It uses other tools such as nmap, nikto, metasploit and hydra. Works in kali linux and Parrot OS , do not run it in Qterminal, works in gnome-terminal and tmux.
